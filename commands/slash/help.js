    ...
    const helpEmbed = new MessageEmbed()
      ...
      .setDescription(
        filteredCommands
          ...
          "\n" +
          `[✨ Support Server](${client.config.supportServer}) | [Issues](${client.config.Issues}) | [Instagram](https://www.instagram.com/septian_agil12/) | [Invite Me](https://discord.com/oauth2/authorize?client_id=${client.config.clientId}&permissions=${client.config.permissions}&scope=bot%20applications.commands)`
      );
